...
import { WebsiteProjects, designProjects, videoProjects } from "../constants";
            ...
            <div className="absolute inset-0 flex justify-end gap-2 m-3 card-img_hover">
              ...
              {website_link ? (
                <div onClick={() => window.open(website_link, "_blank")} className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer">
                  <img src={webIcon} alt="github" className="w-1/2 h-1/2 object-contain" />
                </div>
              ) : (
                ""
              )}
    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          Following projects showcases my skills and experience through real-world examples of my work. Each project is briefly described with links to code repositories and live demo in it. It reflects my ability to solve complex problems,
